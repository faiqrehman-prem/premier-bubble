...
const translations = {
  ...
  en: {
    ...
    startChat: "Welcome! Press the phone button and ask your question. Start by saying: 'Hello' or 'How can you help me today?'",
...
document.addEventListener("DOMContentLoaded", async () => {
  try {
    ...
    if (cfgRes.ok) {
      ...
      if (cfg && cfg.systemPrompt) SYSTEM_PROMPT = cfg.systemPrompt;
      if (cfg && cfg.voice) {
